...
using Azure.AI.Open.Bot.Builder.Community.PromptConfig;
...
namespace Azure.AI.Open.Bot.Builder.Community
{
    ...
    {
        public OpenAIPromptDialog([CallerFilePath] string sourceFilePath = "", [CallerLineNumber] int sourceLineNumber = 0) : base()
        {
            RegisterSourceLocation(sourceFilePath, sourceLineNumber);
        }

        [JsonProperty("$Kind")]
        public const string Kind = "OpenAIPromptDialog";
