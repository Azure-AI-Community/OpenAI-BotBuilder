...
/// <summary>
///  Prompt chat completions dialog.
/// </summary>
public class PromptChatCompletionsDialog : Dialog
{
    public PromptChatCompletionsDialog([CallerFilePath] string sourceFilePath = "",
        [CallerLineNumber] int sourceLineNumber = 0) : base()
    {
        RegisterSourceLocation(sourceFilePath, sourceLineNumber);
    }

    [JsonProperty("$Kind")] public const string Kind = "PromptChatCompletionsDialog";
        ...
        CancellationToken cancellationToken = new CancellationToken())
    {
        ...
        var promptOptions = promptConfig.GenerateChatCompletionsOptions(getPromptConfig);
        ...
        var jResult = await openAI.InvokeAsync("GetChatCompletionsAsync", promptOptions);
